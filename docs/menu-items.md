...
Menu labels are used as key, whilst the value are the links. When a slug (`/about-me`) is used then the matching post will not be loaded in the timeline (see [Page post-types]({% link post-types.md %}#page)).
