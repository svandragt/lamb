...
sudo apt update
sudo apt install php8.4 php8.4-gettext php8.4-mbstring php8.4-sqlite3 php8.4-mysql php8.4-xml php8.4-gd
...
# Install viv, the dependency installer (no apt package; there is no PHP toolchain to conflict with)
