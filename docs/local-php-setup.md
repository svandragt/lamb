...
sudo apt update
sudo apt install php8.4 php8.4-gettext php8.4-mbstring php8.4-sqlite3 php8.4-xml php8.4-gd composer
# PHP 8.4–8.5 are supported; replace 8.4 with your preferred version
# php8.4-sqlite3 ships pdo_sqlite, the driver Lamb's database library actually connects through
