...
- `/listings` and `/listings/feed` for posts marked `post-type: listing`.
...
* [Listings]({{ site.baseurl }}{% link listings.md %}): Add `post-type: listing` to front-matter to offer something for sale.
