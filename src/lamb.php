...
function remove_body_tags(string $body, array $tags): string
{
    foreach ($tags as $tag) {
        ...
        // reports. Demanding whitespace on both sides instead leaves the tag in
        // place for most real bodies — `Hello #php.`, `Hello #php, ok`, `#php at
        // the start` — while Micropub's category delete-values still answer
        // success, so the client is told the tag is gone.
        //
